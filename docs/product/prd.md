...
* or how architectural decisions were made.
...
Prototype ideas quickly without sacrificing maintainability.
...
Increase engineering productivity while retaining full control over implementation.
